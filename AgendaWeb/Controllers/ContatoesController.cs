...
namespace AgendaWeb.Controllers
{
    ...
    {
        private readonly AgendaWebContext _context;

        public ContatoesController(AgendaWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Telefone,Endereco")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Telefone,Endereco")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
